...
sensor readings and publishes them to Azure EventHubs (Kafka) for consumption 
by other components. It simulates both normal machine operation and failure 
conditions based on statistical models derived from reference data.
...
- Publishing messages to Azure EventHubs (Kafka) in a consistent, well-defined format
